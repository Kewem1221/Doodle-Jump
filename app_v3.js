...
class App {
  ...
  run = () => {
    ...
    document.addEventListener("touchend", this.touchControl);
  ...
  createStartPage = (btnText) => {
    ...
    startPage.innerHTML = `
      <ul>
      <li>Press ArrowLeft or swipe left to move left.</li>
      <li>Press ArrowRight or swipe right to move right.</li>
      <li>Press ArrowUp or swipe up to move straight.</li>
      </ul>
